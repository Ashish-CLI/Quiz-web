    ...
    <div className="sdashmain flex flex-col relative h-screen md:flex-row">
      ...
      <div className="sdashleft w-full md:w-1/5 bg-[#695ae0] flex-row relative">
        <ul className="flex-row  space-y-6 mt-20 mx-5 text-2xl">
          <li className="flex p-2 rounded-lg cursor-pointer transition-colors duration-200 hover:bg-[#8d7ff2] gap-5 ml-2 items-center">
            <svg
          ...
          <li className="flex p-2 rounded-lg cursor-pointer transition-colors duration-200 hover:bg-[#8d7ff2] gap-5 ml-1 items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={30}
              height={30}
